...
const legacyLandmarks = [
  ...
  content: {
    ...
    ar: {
      ...
      description:
        "مبنى البلدية التاريخي في قلب المدينة القديمة في لوبيك.",
  ...
  content: {
    en: {
      ...
      facts: [
        ...
        {
          label: "Mann family",
          value: "Owned the house from 1841 to 1891",
        },
        {
    ...
    de: {
      ...
      story:
        "Das Buddenbrookhaus in der Mengstraße 4 wurde 1758 für den Kaufmann Johann Michael Croll erbaut. 1841 kaufte Johann Siegmund Mann, der Großvater von Thomas und Heinrich Mann, das Haus. Bis 1891 blieb es im Besitz der Familie Mann. Weltberühmt wurde das Gebäude später durch Thomas Manns Roman Buddenbrooks aus dem Jahr 1901. Das Haus der Familie im Roman wurde von diesem realen Gebäude inspiriert, auch wenn Thomas Mann viele Details literarisch veränderte.",
      ...
      facts: [
        ...
        {
          label: "Familie Mann",
          value: "Von 1841 bis 1891 im Familienbesitz",
        },
        {
          label: "Literatur",
    ...
    fr: {
      ...
      facts: [
        ...
        {
          label: "Famille Mann",
          value: "Propriétaire de 1841 à 1891",
        },
        {
          label: "Littérature",
    ...
    ar: {
      ...
      story:
        "بُني بودنبروك هاوس في شارع مينغ شتراسه رقم 4 عام 1758 للتاجر يوهان ميشائيل كرول. وفي عام 1841 اشترى المنزل يوهان زيغموند مان، جد الكاتبين توماس وهاينريش مان، وبقي في ملكية عائلة مان حتى عام 1891. وأصبح المنزل مشهوراً عالمياً بعد نشر رواية بودنبروكس لتوماس مان عام 1901، حيث استلهم الكاتب منزل العائلة في الرواية من هذا المبنى الحقيقي، مع تغيير بعض التفاصيل لأغراض أدبية.",
      ...
      facts: [
        ...
        {
          label: "عائلة مان",
          value: "امتلكت المنزل من 1841 إلى 1891",
        },
        {
